    ...
    return (
        <>
            {markdown ? (
                <>
                    <article
                        className="prose max-w-none select-text pt-4 text-ctp-text dark:prose-invert
                            selection:bg-ctp-lavender selection:text-ctp-crust prose-headings:text-ctp-text
                            prose-h2:mt-14 prose-h2:text-ctp-lavender prose-h3:mb-5 prose-h3:mt-12
                            prose-h3:text-ctp-subtext1 prose-h4:mb-4 prose-h4:mt-10 prose-h4:w-fit prose-h4:border-l-8
                            prose-h4:border-ctp-lavender prose-h4:bg-ctp-surface0 prose-h4:px-3 prose-h4:py-1
                            prose-h4:text-ctp-subtext0 prose-a:text-ctp-lavender prose-a:no-underline
                            prose-blockquote:border-ctp-surface0 prose-blockquote:not-italic
                            prose-blockquote:text-ctp-overlay1 prose-strong:font-bold prose-strong:text-ctp-teal
                            prose-em:italic prose-em:text-ctp-sky prose-kbd:select-none prose-kbd:border
                            prose-kbd:border-b-4 prose-kbd:border-ctp-surface2 prose-kbd:text-ctp-subtext1
                            prose-kbd:shadow-none prose-pre:rounded prose-pre:border-4 prose-pre:border-ctp-crust
                            prose-pre:bg-ctp-crust prose-pre:text-ctp-text prose-pre:scrollbar-thin
                            prose-pre:scrollbar-thumb-ctp-surface0 prose-th:text-ctp-lavender prose-img:mx-auto
                            ...
                            hover:prose-kbd:text-ctp-lavender hover:prose-pre:scrollbar-thumb-ctp-surface2
                            prose-inline-code:break-words prose-inline-code:rounded prose-inline-code:bg-ctp-surface0
