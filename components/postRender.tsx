        ...
        <>
            <article
                className="prose max-w-none select-text pt-4 text-ctp-text dark:prose-invert selection:bg-ctp-lavender
                    ...
                    prose-h4:border-l-8 prose-h4:border-ctp-lavender prose-h4:bg-ctp-surface0 prose-h4:px-3
                    prose-h4:py-1 prose-h4:text-ctp-subtext0 prose-a:text-ctp-lavender prose-a:no-underline
                    ...
                    prose-img:rounded prose-img:shadow-md prose-img:shadow-ctp-crust prose-hr:border-ctp-surface2
                    hover:prose-a:underline hover:prose-kbd:border-ctp-lavender hover:prose-kbd:text-ctp-lavender
