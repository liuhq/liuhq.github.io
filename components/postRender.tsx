    ...
    return (
        <article
            className="prose max-w-none select-text pt-4 text-ctp-text dark:prose-invert selection:bg-ctp-lavender
                ...
                prose-pre:text-ctp-text prose-pre:scrollbar-thin prose-pre:scrollbar-thumb-ctp-surface0
                prose-th:text-ctp-lavender prose-img:mx-auto prose-img:rounded prose-img:shadow-md
                prose-img:shadow-ctp-crust prose-hr:border-ctp-surface2 hover:prose-a:underline
